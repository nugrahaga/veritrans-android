...
-keep class com.midtrans.sdk.corekit.core.NewSdkBuilder {*;}
-keep class com.midtrans.sdk.corekit.core.SdkCoreKitBuilder {*;}
-keep class com.midtrans.sdk.corekit.core.NewUiKitBuilder {*;}
